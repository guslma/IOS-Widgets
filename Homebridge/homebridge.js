...
class Configuration {
    ...
    hbServiceMachineBaseUrl = 'http://000.000.000.000:8581'; // location of your system running the hb-service, e.g. http://192.168.178.33:8581
    userName = '##########'; // username of administrator of the hb-service
    ...
    title_uiService = 'Processo: ';
    title_systemGuiName = 'Servidor: '; // name of the system your service is running on
...
function isTimeToNotifyAgain(dateToCheck) {
    ...
    let now = new Date();
    let timeBetweenDates = parseInt((now.getTime() - dateInThePast.getTime()) / 600); // seconds
